...
def fused_moe(
    ...
    expert_num = 8
    start_expert_id = 0
    gather_expand_idx, gather_combine_idx, token_count, cusum_token_count = (
        tmo.moe_gen_idx(topk_ids, expert_num)
    )
    expand_hidden_states = tmo.moe_expand_input(
        hidden_states, gather_expand_idx, cusum_token_count, start_expert_id, expert_num
    )
